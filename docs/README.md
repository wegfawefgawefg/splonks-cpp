...
- `realnet_splonks_plan.md`: next public-internet networking phase: Gubsy room discovery, NAT traversal, later relay/Steam, and Splonks lockstep integration boundaries.
