...
These helpers create active ents, call `SetEntAs(...)`, then place by center and do not snap.

### Throw / proj spawn paths

- [throw.cpp](/home/vega/Coding/GameDev/Splonks/splonks-cpp/src/ents/common/throw.cpp)
  thrown ents spawn from the thrower's fixed center
...
- [hang.cpp](/home/vega/Coding/GameDev/Splonks/splonks-cpp/src/ents/common/hang.cpp)
  ...
  This one is probably intentional lattice alignment, but odd-size ents could still end up fractional depending on anchor math.
