...
constexpr AudioAssetId Buzz = HashAudioAssetIdConstexpr("buzz");
constexpr AudioAssetId BeeSplat = HashAudioAssetIdConstexpr("bee_splat");
constexpr AudioAssetId FleshGuyStep0 = HashAudioAssetIdConstexpr("fleshguy_step_0");
constexpr AudioAssetId FleshGuyStep1 = HashAudioAssetIdConstexpr("fleshguy_step_1");
constexpr AudioAssetId FleshGuyImpact0 = HashAudioAssetIdConstexpr("fleshguy_impact_0");
constexpr AudioAssetId FleshGuyImpact1 = HashAudioAssetIdConstexpr("fleshguy_impact_1");
constexpr AudioAssetId FleshmanJump = HashAudioAssetIdConstexpr("fleshman_jump");
...
constexpr AudioAssetId MonkeyNoise1 = HashAudioAssetIdConstexpr("monkey_1");
constexpr AudioAssetId MonkeyNoise2 = HashAudioAssetIdConstexpr("monkey_2");
constexpr AudioAssetId MonkeyNoise3 = HashAudioAssetIdConstexpr("monkey_3");
constexpr AudioAssetId MonkeyNoise4 = HashAudioAssetIdConstexpr("monkey_4");
constexpr AudioAssetId MonkeyNoise5 = HashAudioAssetIdConstexpr("monkey_5");
