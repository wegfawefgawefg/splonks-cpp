...
void AddStageFingerprint(FingerprintWriter& writer, const Stage& stage,
    ...
    writer.AddFixedScalar(stage.gravity);
...
void AddEntFingerprint(FingerprintWriter& writer, const Ent& ent) {
    ...
    writer.AddFixedVec2(ent.pos);
    writer.AddFixedVec2(ent.vel);
    writer.AddFixedVec2(ent.acc);
    ...
    writer.AddFixedScalar(ent.counter_a);
    writer.AddFixedScalar(ent.counter_b);
    writer.AddFixedScalar(ent.counter_c);
    writer.AddFixedScalar(ent.counter_d);
