...
struct StageRotationState {
    ...
    int quarter_turns = 1;
    sim::FxVec2 pivot = sim::FxVec2{sim::Scalar::zero(), sim::Scalar::zero()};
...
struct PerformanceStats {
    ...
    double network_pump_smoothed_ms = 0.0;
    double lockstep_hash_smoothed_ms = 0.0;
    double rollback_replay_smoothed_ms = 0.0;
    double multiplayer_sim_total_smoothed_ms = 0.0;
    ...
    double network_pump_peak_ms = 0.0;
    double lockstep_hash_peak_ms = 0.0;
    double rollback_replay_peak_ms = 0.0;
    double multiplayer_sim_total_peak_ms = 0.0;
