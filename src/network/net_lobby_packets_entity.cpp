...
EntitySpawnedMessageEntry MakeEntitySpawnedMessageEntry(const NetMessage& message) {
    ...
    EntitySpawnedMessageEntry entry{
        ...
        .light_color_r = payload != nullptr ? payload->light_color.r : 1.0F,
        .light_color_g = payload != nullptr ? payload->light_color.g : 1.0F,
        .light_color_b = payload != nullptr ? payload->light_color.b : 1.0F,
...
NetMessage MakeEntitySpawnedMessage(const EntitySpawnedMessageEntry& entry) {
    ...
    EntitySpawnedMessage payload{
        ...
        .light_color = Color3::New(entry.light_color_r, entry.light_color_g, entry.light_color_b),
