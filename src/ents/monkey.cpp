...
extern const EntSpec kMonkeySpec{
    ...
    .counter_a = ToFxScalar(20.0F),
    .counter_b = ToFxScalar(static_cast<float>(kMonkeyGrabCooldownFrames)),
    .counter_d = ToFxScalar(static_cast<float>(static_cast<int>(MonkeyState::Hang))),
