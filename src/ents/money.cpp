...
extern const EntSpec kGoldSpec{
    ...
    .buoyancy = sim::ToSimScalar(0.55F),
    .self_light = sim::ToSimScalar(0.15F),
    .light_strength = sim::ToSimScalar(0.30F),
    .light_color = sim::ToSimColor3(kGoldLightColor),
    .light_radius = 3,
...
extern const EntSpec kGoldChunkSpec{
    ...
    .self_light = sim::ToSimScalar(0.12F),
    .light_strength = sim::ToSimScalar(0.14F),
    .light_color = sim::ToSimColor3(kGoldLightColor),
    .light_radius = 2,
    .draw_layer = DrawLayer::Foreground,
    .facing = Side::Left,
...
extern const EntSpec kGoldNuggetSpec{
    ...
    .can_be_stunned = false,
    .buoyancy = sim::ToSimScalar(0.35F),
    .self_light = sim::ToSimScalar(0.18F),
    .light_strength = sim::ToSimScalar(0.22F),
    .light_color = sim::ToSimColor3(kGoldLightColor),
    .light_radius = 3,
    .draw_layer = DrawLayer::Foreground,
    .facing = Side::Left,
...
extern const EntSpec kGoldBarsSpec{
    ...
    .can_be_stomped = false,
    .can_be_stunned = false,
    .buoyancy = sim::ToSimScalar(0.25F),
    .self_light = sim::ToSimScalar(0.22F),
    .light_strength = sim::ToSimScalar(0.28F),
    .light_color = sim::ToSimColor3(kGoldLightColor),
    .light_radius = 4,
    .draw_layer = DrawLayer::Foreground,
    .facing = Side::Left,
