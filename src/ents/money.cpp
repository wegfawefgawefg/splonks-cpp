...
extern const EntSpec kGoldSpec{
    ...
    .buoyancy = ToFxScalar(0.55F),
    .self_light = ToFxScalar(0.15F),
    .light_strength = ToFxScalar(0.30F),
    .light_color = ToFxColor3(kGoldLightColor),
    .light_radius = 3,
...
extern const EntSpec kGoldChunkSpec{
    ...
    .self_light = ToFxScalar(0.12F),
    .light_strength = ToFxScalar(0.14F),
    .light_color = ToFxColor3(kGoldLightColor),
    .light_radius = 2,
    .draw_layer = DrawLayer::Foreground,
    .facing = Side::Left,
...
extern const EntSpec kGoldNuggetSpec{
    ...
    .can_be_stunned = false,
    .buoyancy = ToFxScalar(0.35F),
    .self_light = ToFxScalar(0.18F),
    .light_strength = ToFxScalar(0.22F),
    .light_color = ToFxColor3(kGoldLightColor),
    .light_radius = 3,
    .draw_layer = DrawLayer::Foreground,
    .facing = Side::Left,
...
extern const EntSpec kGoldBarsSpec{
    ...
    .can_be_stomped = false,
    .can_be_stunned = false,
    .buoyancy = ToFxScalar(0.25F),
    .self_light = ToFxScalar(0.22F),
    .light_strength = ToFxScalar(0.28F),
    .light_color = ToFxColor3(kGoldLightColor),
    .light_radius = 4,
    .draw_layer = DrawLayer::Foreground,
    .facing = Side::Left,
