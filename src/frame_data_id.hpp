...
constexpr FrameDataId PlayerDab = HashFrameDataIdConstexpr("player_dab");
constexpr FrameDataId PlayerBald = HashFrameDataIdConstexpr("player_bald");
...
constexpr FrameDataId Ankh = HashFrameDataIdConstexpr("ankh");
...
constexpr FrameDataId HandSlot = HashFrameDataIdConstexpr("hand_slot");
constexpr FrameDataId BackSlot = HashFrameDataIdConstexpr("back_slot");
constexpr FrameDataId GoldIdol = HashFrameDataIdConstexpr("gold_idol");
constexpr FrameDataId CrystalIdol = HashFrameDataIdConstexpr("crystal_idol");
...
constexpr FrameDataId CapeClosed = HashFrameDataIdConstexpr("cape_item");
constexpr FrameDataId CapeOpen = HashFrameDataIdConstexpr("cape_open");
constexpr FrameDataId Cape = HashFrameDataIdConstexpr("cape");
constexpr FrameDataId CapeBack = HashFrameDataIdConstexpr("cape_back");
constexpr FrameDataId CapeBackOpen = HashFrameDataIdConstexpr("cape_back_open");
constexpr FrameDataId CapeSide = HashFrameDataIdConstexpr("cape_side");
constexpr FrameDataId CapeSideOpen = HashFrameDataIdConstexpr("cape_side_open");
constexpr FrameDataId CapeSideBack = HashFrameDataIdConstexpr("cape_side_back");
constexpr FrameDataId CapePickup = CapeClosed;
...
constexpr FrameDataId MittNoGrav = HashFrameDataIdConstexpr("mitt_no_grav");
...
constexpr FrameDataId BowLooseEmpty = HashFrameDataIdConstexpr("bow_loose_empty");
constexpr FrameDataId BowPullEmpty = HashFrameDataIdConstexpr("bow_pull_empty");
constexpr FrameDataId BowLooseLoaded = HashFrameDataIdConstexpr("bow_loose_loaded");
constexpr FrameDataId BowPullLoaded = HashFrameDataIdConstexpr("bow_pull_loaded");
constexpr FrameDataId Bow = BowLooseLoaded;
...
constexpr FrameDataId Mantrap = HashFrameDataIdConstexpr("mantrap");
constexpr FrameDataId MantrapWalk = HashFrameDataIdConstexpr("mantrap_walk");
constexpr FrameDataId MantrapEat = HashFrameDataIdConstexpr("mantrap_eat");
constexpr FrameDataId Piranha = HashFrameDataIdConstexpr("pirana");
constexpr FrameDataId PiranhaSwim = HashFrameDataIdConstexpr("pirana_swim");
constexpr FrameDataId PiranhaBite = HashFrameDataIdConstexpr("pirana_bite");
constexpr FrameDataId PiranhaDead = Piranha;
constexpr FrameDataId MonkeyStand = HashFrameDataIdConstexpr("monkey_stand");
constexpr FrameDataId MonkeyDead = HashFrameDataIdConstexpr("monkey_dead");
constexpr FrameDataId MonkeyHang = HashFrameDataIdConstexpr("monkey_hang");
constexpr FrameDataId MonkeyDown = HashFrameDataIdConstexpr("monkey_down");
...
constexpr FrameDataId IdleTrapDoor = HashFrameDataIdConstexpr("idle_trap_door");
constexpr FrameDataId ThwompTrap = HashFrameDataIdConstexpr("thwomp_trap");
constexpr FrameDataId SquisherBlock = HashFrameDataIdConstexpr("squisher_block");
constexpr FrameDataId BeamEmitter = HashFrameDataIdConstexpr("beam_emitter");
constexpr FrameDataId Beam = HashFrameDataIdConstexpr("beam");
