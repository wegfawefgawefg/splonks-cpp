...
FxAABB MakeShopTestArea(const ShopTestStallSpec& stall) {
    constexpr int kShopTopY = 4;
    constexpr int kShopBottomY = 10;
...
std::optional<VID> SpawnShopTestShop(
    ...
    const FxAABB shop_area = MakeShopTestArea(stall);
    ...
    const std::optional<VID> shopkeeper_vid = SpawnStageEntAtAuthoredTopLeft(
        state,
        EntType::Shopkeeper,
        FVec2::New(
...
void SpawnShopTestOwnedItem(
    ...
    const std::optional<VID> item_vid = SpawnStageEntAtAuthoredTopLeft(
        state,
        spec.type_,
        FVec2::New(
...
void SpawnShopTestCrapsTable(
    ...
    const std::optional<VID> dice_vid = SpawnStageEntAtAuthoredTopLeft(
        state,
        EntType::Dice,
    ...
    const std::optional<VID> prize_vid = SpawnStageEntAtAuthoredTopLeft(
        state,
        EntType::JetPack,
...
void SpawnShopTestStoreLight(State& state, int anchor_tile_x, int start_tile_y) {
    ...
    (void)SpawnStageEntAtAuthoredTopLeft(state, EntType::StoreLight, *pos);
}
