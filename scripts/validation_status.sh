...
check print_file_check "Linux release archive" "${repo_root}/dist/releases/splonks-0.1.0-linux-x86_64.tar.gz"
check print_file_check "Linux release checksum" "${repo_root}/dist/releases/splonks-0.1.0-linux-x86_64.tar.gz.sha256"
...
check print_file_check "Android release AAB" "${repo_root}/dist/splonks-android/splonks-0.1.0-android-release.aab"
...
check print_file_check "iOS IPA" "${repo_root}/dist/releases/splonks-0.1.0-ios.ipa"
check print_file_check "iOS IPA checksum" "${repo_root}/dist/releases/splonks-0.1.0-ios.ipa.sha256"
